...
import { messageEmptyPatientListDOM, patientsListDOM, removePatientModalDOM, removeBtnConfirmDOM} from './selectors.js';
...
export class UI {
    ...
    showModalRemove(id) {
        removePatientModalDOM.classList.replace('hidden', 'block')
        removeBtnConfirmDOM.dataset.patient = id;
        console.log(removeBtnConfirmDOM)
    }
...
/* import { patients } from './app.js';
import { messageEmptyPatientListDOM, patientsListDOM } from './selectors.js';
    ...
    showPatient(patient) {        
        ...
        patientContainerDOM.classList.add('patient__container')
            ...
            patientButtonsDOM.classList.add('patient__buttons-container')
                ...
                // Botón de editar
                const patientEditButtonDOM = document.createElement('button');
                patientEditButtonDOM.classList.add('patient__buttons', 'patient__buttons--edit');
                patientEditButtonDOM.textContent = 'Edit'
                patientEditButtonDOM.dataset.patient = id;
                patientEditButtonDOM.onclick = () => patients.editPatient(id);
                ...
                // Botón de eliminar
                const patientRemoveButtonDOM = document.createElement('button');
                patientRemoveButtonDOM.classList.add('patient__buttons', 'patient__buttons--remove');
                patientRemoveButtonDOM.textContent = 'Remove'
                patientRemoveButtonDOM.dataset.patient = id;
                patientRemoveButtonDOM.onclick = () => patients.removePatient(id);
