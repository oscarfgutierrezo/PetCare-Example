...
export const removeModalBtnConfirmDOM = document.querySelector('#remove-patient-modal__btn-confirm');
export const removeModalBtnCancelDOM = document.querySelector('#remove-patient-modal__btn-cancel');
